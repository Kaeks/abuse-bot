...
let testexample =
	...
	.addSub(new SubCommand('a', argumentValues.NONE)
	...
	).addSub(new SubCommand('b', argumentValues.REQUIRED)
	...
	).addSub(new SubCommand('c', argumentValues.OPTIONAL)
		.addDoc('', 'Example sub-command with an optional sub-command')
		.addSub(new SubCommand('ca', argumentValues.OPTIONAL)
	...
	).addSub(new SubCommand('d', argumentValues.NULL, permissionLevels.SERVER_SUPERUSER)
		.addSub(new SubCommand('da', argumentValues.OPTIONAL)
		...
		).addSub(new SubCommand('db', argumentValues.OPTIONAL, permissionLevels.BOT_SUPERUSER)
				.addDoc(
					'[yah]',
